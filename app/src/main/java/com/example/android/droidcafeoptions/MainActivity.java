...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivity", "Question 1 : menu_main.xml");
        Log.d("MainActivity", "Question 2 : onOptionsItemSelected(MenuItem item)");
        Log.d("MainActivity", "Question 3 : AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(\"Alert\");");
        Log.d("MainActivity", "Question 4 : Dans la méthode onCreateContextMenu() dans Fragment.");
    }
